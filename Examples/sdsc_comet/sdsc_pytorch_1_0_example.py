...
if __name__ == "__main__":
    ...
    torch.distributed.init_process_group(backend='nccl', init_method='file:///home/neesittg/scale_test/sdsc/pytorch/pytorch-shared-filesystem-init.o' + slurmjobid, rank=rank_id, world_size=ntasks)
